...
import com.interfaces.IReplicatedServer;
...
public class ReplicatedServer extends java.rmi.server.UnicastRemoteObject implements IReplicatedServer {
	...
	private static final ArrayList<IReplicatedServer> serverlist = new ArrayList<IReplicatedServer>();
...
*/
    ...
    @Override 
    public void addServer(ReplicatedServer newServer) throws UnknownHostException, RemoteException {
        serverlist.add(newServer);
    }

    @Override 
    public void removeServer(IReplicatedServer server) throws UnknownHostException, RemoteException {
        if (serverlist.contains(server)) {
            boolean lider = ((ReplicatedServer)server).isleader();
